...
```
% sudo pip install "git+git://github.com/mongolab/mongoctl.git#egg=mongoctl-0.1.0"
```
...
```
% sudo pip install --upgrade "git+git://github.com/mongolab/mongoctl.git#egg=mongoctl-0.1.0"
```
